...
pub mod models;
mod utils;
// ANCHOR_END: declare modules

// ANCHOR: re-export
pub use crate::client::commands::*;
pub use crate::client::ipc::IpcPoolConfigBuilder;
pub use crate::client::models::Protocol;
// ANCHOR_END: re-export

use std::sync::Arc;

use crate::client::{
    error::Result,
    ipc::{IpcConnectionPool, IpcPoolConfig},
    mihomo::Mihomo,
};
...
impl Builder {
    ...
    pub fn build(self) -> Result<Arc<RwLock<Mihomo>>> {
        ...
        IpcConnectionPool::init(pool_config)?;

        let mihomo = Arc::new(RwLock::new(Mihomo {
            protocol,
            external_host,
            external_port,
            secret,
